...
function Home() {
    ...
    return (
        <div className="relative mt-[80px] flex items-center justify-center h-[550px] bg-[url('https://htmldemo.net/amber/amber/assets/images/slider/slider1-1.png')] bg-cover bg-center bg-no-repeat ">
            <div className="absolute w-[1200px]">
